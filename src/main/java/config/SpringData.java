...
@EnableJpaRepositories("email.sender.repository")
public class SpringData extends WebMvcConfigurerAdapter {
    ...
    private static final String ENTITYMANAGER_PACKAGES_TO_SCAN = "email.sender.entity";
    ...
    public DataSource dataSource() {
        try {
            ...
            dataSource.setUrl("jdbc:mysql://localhost:3306/emailsender?autoReconnect=true&amp;createDatabaseIfNotExist=true&amp;");
